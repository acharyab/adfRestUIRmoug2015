...
public class StudentClient {
    ...
    public List<Student> getStudentNotEnrolled(String courseId) throws Exception {
        String url = "";
        Client client = Client.create();
        List<Student> studentList = new ArrayList<Student>();
        
        url = "http://127.0.0.1:7101/adfRestServiceRmoug2015-service-context-root/resources/service/studentsNotEnrolled?courseId=" + courseId;
        System.out.println("urls is: ! " + url);
